...
class MostSubXResultsByEvent < Statistic
  THRESHOLDS = {
    ...
    "666"    => { field: :average, values: [15000, 12000, 10500],                   labels: ["sub-2:30", "sub-2:00", "sub-1:45"] },
    "777"    => { field: :average, values: [24000, 21000, 18000],                   labels: ["sub-4:00", "sub-3:30", "sub-3:00"] },
    "333oh"  => { field: :average, values: [1500, 1200, 1000],                      labels: %w[sub-15 sub-12 sub-10] },
    "minx"   => { field: :average, values: [6000, 5000, 4500, 4000, 3500, 3000],   labels: ["sub-1:00", "sub-50", "sub-45", "sub-40", "sub-35", "sub-30"] },
